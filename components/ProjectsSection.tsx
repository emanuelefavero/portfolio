...
export default function ProjectsSection() {
  return (
    <>
      ...
      >
        <div className='w-full max-w-(--breakpoint-3xl) items-center justify-center px-4 pb-44 pt-44 2xs:px-10 xs:px-20 sm:px-28 md:px-20 lg:px-28 xl:px-40'>
          <h2 className='mb-8 text-2xl font-bold text-indigo-500'>
            <Link href='#projects'>Projects</Link>
          </h2>
          <h3 className='mb-12 text-lg font-extrabold text-indigo-50 2xs:text-4xl'>
            Work / Portfolio
          </h3>
