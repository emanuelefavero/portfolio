...
export default function PageNavigation() {
  ...
  return (
    <div className='fixed right-0 top-0 z-40 hidden h-screen w-[4.2rem] select-none flex-col items-center justify-center gap-4 2xs:flex'>
      <div className='hidden flex-col items-center justify-center gap-4 xs:flex'>
        {/* Home */}
        <ScrollLink
          title='Home'
          to='home'
