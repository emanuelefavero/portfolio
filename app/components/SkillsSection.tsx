...
export default function ProjectsSection() {
  return (
    <>
      ...
      <section
        id='skills'
        className='relative -top-16 flex w-full max-w-screen-3xl flex-col items-start justify-start px-4 pb-44 pt-36 text-slate-500 2xs:px-10 xs:px-20 sm:px-28 md:px-20 lg:px-28 xl:px-40'
      >
        {/* TEXT */}
