...
export default function HeroInfo({ numberOfRepositories }: Props) {
  return (
    <>
      <div className='absolute -right-8 top-10 hidden text-xl font-medium text-slate-700 sm:right-8 sm:block sm:text-sm md:hidden lg:-right-8 lg:block lg:text-sm xl:text-xl'>
